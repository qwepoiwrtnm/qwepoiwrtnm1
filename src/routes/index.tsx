  ...
  return (
    <SiteLayout>
      ...
      <section aria-labelledby="features-heading" className="relative px-5 py-20 sm:px-8 lg:py-28">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[36rem] bg-[radial-gradient(55%_45%_at_18%_8%,oklch(0.42_0.16_340_/_20%),transparent_70%)]"
        />
      ...
      <section id="preview" aria-labelledby="gallery-heading" className="relative scroll-mt-28 px-5 py-20 sm:px-8 lg:py-28">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-10 -z-10 h-[34rem] bg-[radial-gradient(50%_45%_at_85%_10%,oklch(0.4_0.12_300_/_22%),transparent_70%)]"
        />
        <div className="mx-auto max-w-6xl">
          <Reveal>
            <SectionHeading
